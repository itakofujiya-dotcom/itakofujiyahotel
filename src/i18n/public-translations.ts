...
const publicPhrases: readonly [string, string][] = [
  ...
  ['客室を見る', '객실 보기'],
  ['館内施設を見る', '호텔 시설 보기'],
  ['館内で過ごす、心ほどけるひととき。', '호텔에서 보내는 편안한 시간.'],
  ['ご滞在を、より心地よく。', '더욱 편안한 숙박을 위해.'],
  [
    '潮来富士屋ホテルでは、ご滞在をより快適にお過ごしいただける館内施設をご用意しております。旅の疲れを癒し、ゆったりとした時間をお過ごしください。',
    '이타코 후지야 호텔은 더욱 편안한 숙박을 위한 시설을 갖추고 있습니다. 여행의 피로를 풀며 여유로운 시간을 보내세요.',
  ],
  ['大浴場', '대욕장'],
  ['旅の疲れを癒す、くつろぎの湯。', '여행의 피로를 푸는 편안한 목욕.'],
  [
    '一日の旅やお仕事の疲れを、ゆったりと癒していただける館内大浴場。広々とした湯船で足を伸ばし、くつろぎのひとときをお過ごしください。',
    '하루 동안 쌓인 여행과 업무의 피로를 편안하게 풀 수 있는 호텔 대욕장입니다. 넓은 욕조에서 다리를 뻗고 편안한 시간을 보내세요.',
  ],
  [
    '男女それぞれの浴場をご用意しております。',
    '남녀 대욕장을 각각 마련했습니다.',
  ...
  ['女性大浴場入口', '여성 대욕장 입구'],
  ['男性大浴場入口', '남성 대욕장 입구'],
  ['窓から水郷を望む大浴場', '창밖으로 수향이 보이는 대욕장'],
  ['ホテルロビー', '호텔 로비'],
  [
    'ご到着からご出発まで、ほっとひと息。',
    '도착부터 출발까지, 잠시 편안한 휴식을.',
  ],
  [
    'チェックイン・チェックアウトの際はもちろん、お出かけ前後のひと休みにもご利用いただけるロビースペースです。',
    '체크인과 체크아웃은 물론, 외출 전후 잠시 쉬어갈 수 있는 로비 공간입니다.',
  ],
  ['マッサージチェア', '마사지체어'],
  ['旅の疲れを、ゆったりリフレッシュ。', '여행의 피로를 편안하게 풀어보세요.'],
  [
    '1階にマッサージチェアを2台ご用意しております。ご宿泊中のリラックスタイムに、どうぞご利用ください。',
    '1층에 마사지체어 2대를 마련했습니다. 투숙 중 편안한 휴식 시간에 이용해 주세요.',
  ],
  ['1階', '1층'],
  ['2台', '2대'],
  [
    'ロビーの窓辺に設置された2台のマッサージチェア',
    '로비 창가에 설치된 마사지체어 2대',
  ],
  [
    '館内に設置された2台のマッサージチェア',
  ...
  ['ラウンジ アリラン', '라운지 아리랑'],
  ['お酒とともに、くつろぎのひとときを。', '술과 함께 편안한 시간을 보내세요.'],
  [
    '館内には、お酒を楽しみながらゆっくりとお過ごしいただけるラウンジ「アリラン」がございます。ご宿泊の夜のひとときに、どうぞお気軽にお立ち寄りください。',
    '호텔에는 술을 즐기며 편안하게 머물 수 있는 라운지 아리랑이 있습니다. 투숙 중 저녁 시간에 부담 없이 들러주세요.',
  ],
  ['メニュー 1', '메뉴 1'],
  ['メニュー 2', '메뉴 2'],
  ['メニュー', '메뉴'],
  ...
  ['ラウンジ アリラン ドリンクメニュー', '라운지 아리랑 음료 메뉴'],
  ['ラウンジ アリラン フードメニュー', '라운지 아리랑 음식 메뉴'],
  ['周辺観光を見る', '주변 관광 보기'],
  ['電車でお越しの方', '전철로 오시는 분'],
  ['お車でお越しの方', '자동차로 오시는 분'],
  ...
  ['無料駐車場', '무료 주차장'],
  ['ホテル向かいの潮来市営駐車場', '호텔 맞은편 이타코 시영 주차장'],
  ['約20台', '약 20대'],
  ['大型車駐車可', '대형 차량 주차 가능'],
  ['24時間利用可能', '24시간 이용 가능'],
  [
  ...
  [
    ...
    '이타코역 픽업도 가능합니다. 원하시는 분은 사전에 문의해 주세요.',
  ],
  ['所在地', '소재지'],
  ['Google Mapsでルートを確認', 'Google 지도에서 경로 확인'],
  ['潮来富士屋ホテル 所在地', '이타코 후지야 호텔 소재지'],
  [
    '潮来富士屋ホテルへ車でお越しの方向けアクセスマップ',
    '이타코 후지야 호텔 자동차 교통 안내 지도',
  ],
  [
    '潮来駅から潮来富士屋ホテルまでのアクセスマップ',
    '이타코역에서 이타코 후지야 호텔까지의 교통 안내 지도',
  ],
  ['メニューを閉じる', '메뉴 닫기'],
  ['メニューを開く', '메뉴 열기'],
  ['メインナビゲーション', '주요 내비게이션'],
